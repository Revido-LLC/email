...
import type { PersistTarget, PersistedMessage, SaveCursorInput, SyncStateRow } from '../mail/store'
...
function harness(
  ...
  return { deps, persisted, enqueued, cursors, deleted }
}
...
describe('makeIncrementalConsumer', () => {
  ...
  it('upserts new inbound messages and enqueues embed + triage for each', async () => {
